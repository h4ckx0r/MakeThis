    ...
    <div class="min-h-screen flex flex-col">
        ...
        <form method="GET" action="{{ route('piezas.catalogo') }}" class="mb-12">
            ...
            <div class="relative max-w-2xl mx-auto mb-6">
                <input type="text" name="search" placeholder="Busca una pieza"
            ...
            <div class="flex flex-wrap gap-2 justify-center">
                @foreach($availableTags as $tag)
                    <label class="badge badge-lg cursor-pointer {{ in_array($tag->id, request('tags', [])) ? 'badge-primary' : 'badge-outline' }}">
