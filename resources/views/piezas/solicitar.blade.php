    ...
    <div class="min-h-screen flex flex-col">
        ...
        <div class="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto mb-12">
            ...
            <a href="{{ route('piezas.propia') }}" class="group">
                <div class="card bg-base-100 border border-base-300 hover:border-primary hover:shadow-xl transition-all duration-300 h-full">
                    <div class="card-body items-center text-center p-8">
                        <div class="w-24 h-24 bg-base-200 rounded-full flex items-center justify-center mb-4 group-hover:bg-primary transition-colors">
                            <svg class="w-12 h-12 text-primary group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('piezas.personalizada') }}" class="group">
                <div class="card bg-base-100 border border-base-300 hover:border-primary hover:shadow-xl transition-all duration-300 h-full">
                    <div class="card-body items-center text-center p-8">
                        ...
                        <p class="text-gray-600 mt-2">Cuéntanos tu idea y nuestros diseñadores crean el modelo perfecto</p>
                        <div class="card-actions justify-center mt-6">
                            <button class="btn btn-primary">Continuar</button>
                        </div>
                    </div>
