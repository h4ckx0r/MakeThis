...
<body class="bg-base-100 text-base-content">
    <div class="min-h-screen flex flex-col">
        ...
        <div class="mb-12">
            ...
            <p class="text-gray-600">Proporciona los detalles de tu pieza para que pueda ser impresa correctamente</p>
        </div>
                ...
                <div class="space-y-6">
                    ...
                    <div id="configAvanzada" class="space-y-4 pt-4 border-t">
                        ...
                        <div>
                            ...
                            <select id="patron_relleno" name="patron_relleno" class="select select-bordered w-full bg-base-200">
