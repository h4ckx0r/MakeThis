            ...
            <section class="border-b border-base-300">
                <div class="mx-auto max-w-7xl px-6 py-2.5">
                    <div class="flex gap-3">
                        {{-- Tab Solicitudes --}}
                        <a href="{{ route('solicitudes-cliente') }}" class="flex items-center justify-center rounded-[10px] border border-base-300 w-[106px] h-[40px]">
                            <span class="text-[16px] font-normal">Solicitudes</span>
                        </a>

                        {{-- Tab Me Gusta (activo) --}}
                        <a href="{{ route('me-gusta-cliente') }}" class="flex items-center justify-center rounded-[10px] border border-base-300 bg-base-200 w-[106px] h-[40px]">
