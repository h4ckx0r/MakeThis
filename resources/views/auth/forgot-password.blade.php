    ...
    <body class="bg-base-100 text-base-content">
        <div class="min-h-screen flex flex-col">
            ...
            <main class="flex-1 flex items-center justify-center px-6 py-12 relative">
                {{-- Flecha de retroceso --}}
                <a href="{{ route('auth.login') }}" class="absolute top-8 left-8 text-2xl hover:opacity-70 transition-opacity">
                ...
                <div class="w-full max-w-md space-y-8">
                    ...
                    {{-- Formulario --}}
                    <form action="{{ route('password.sendOtp') }}" method="POST" class="space-y-6">
                        @csrf
