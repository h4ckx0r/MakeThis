                    ...
                    <form action="/register" method="POST" class="space-y-4">
                        ...
                        <div class="flex justify-center">
                            <div class="border border-base-300 rounded-md p-6 inline-flex items-center gap-4">
                                <input type="checkbox" name="captcha" class="checkbox checkbox-lg border border-black" required />
                        ...
                        <div class="text-center pt-2">
                            <a href="{{ route('home') }}" class="text-[15px] font-normal underline hover:text-primary">
